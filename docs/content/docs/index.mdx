...
<Cards>
  ...
  <Card title="Authentication" href="/docs/authentication" icon="Shield" />
  <Card title="REST API" href="/docs/integration/rest-api" icon="Waypoints" />
  <Card title="MCP Server" href="/docs/integration/mcp-server" icon="Wrench" />
  <Card title="API Reference" href="/docs/api-reference" icon="BookOpen" />
  <Card title="x402 Payment Flow" href="/docs/concepts/x402-payment-flow" icon="ArrowLeftRight" />
</Cards>
