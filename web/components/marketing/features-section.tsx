...
function MicroHeroTwo({ className }: { className?: string }) {
	const [hovered, setHovered] = useState(false)
	const agentRows = [
		{ id: "research-01", name: "RESEARCH AGENT-01", balance: "$12.40", policy: "ACTIVE", spend: "$0.24/D" },
		{ id: "trading-02", name: "TRADING AGENT-02", balance: "$8.75", policy: "ACTIVE", spend: "$1.20/D" },
		{ id: "scraper-03", name: "SCRAPER AGENT-03", balance: "$2.10", policy: "PAUSED", spend: "$0.00/D" },
	]
		...
		>
			...
			<div className="absolute top-[86px] bottom-0 left-0 right-0 px-5 flex flex-col">
				<div className="flex items-center mb-1.5">
					<span className="text-[9px] uppercase tracking-wider text-muted-foreground/40 flex-1">Agent</span>
					<span className="text-[9px] uppercase tracking-wider text-muted-foreground/40 w-[52px] text-right">Balance</span>
					<span className="text-[9px] uppercase tracking-wider text-muted-foreground/40 w-[46px] text-right">Policy</span>
					<span className="text-[9px] uppercase tracking-wider text-muted-foreground/40 w-[44px] text-right">Spend</span>
				</div>
