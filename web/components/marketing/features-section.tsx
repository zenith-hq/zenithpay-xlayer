      ...
      <div className="absolute top-0 bottom-0 left-0 right-[140px] flex flex-col justify-between p-5">
        <div>
          ...
          <p className="text-muted-foreground text-sm leading-relaxed mt-2 max-w-[200px]">
            Set per-transaction limits, daily budgets, and merchant allowlists.
            Deployed onchain — enforced on every payment.
          </p>
        </div>
      </div>
      ...
      <div className="px-5 py-16 sm:px-8 lg:px-12">
        <div className="mb-12">
          ...
          <p className="mt-3 text-[16px] text-muted-foreground max-w-xl">
            Hard limits, zero-gas payments, automatic token swaps, and a full
            audit trail — everything an agent needs to pay safely and
            autonomously.
          </p>
        </div>
