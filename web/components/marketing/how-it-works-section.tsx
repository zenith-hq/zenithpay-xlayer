...
const STEPS = [
  {
    ...
    description:
      "Give your agent a real USDC wallet on X Layer. It holds actual balances — not a simulated account or a custodied float.",
  },
  {
    number: "02",
    label: "Step 2",
    ...
    description:
      "Define per-transaction limits, daily budgets, and which services your agent is allowed to pay. Set it once — it's enforced on every payment.",
  },
  {
    number: "03",
    label: "Step 3",
    ...
    description:
      "Need USDC but holding another token? ZenithPay automatically swaps via OKX DEX before the payment goes out — no manual intervention needed.",
  },
  {
    number: "04",
    label: "Step 4",
