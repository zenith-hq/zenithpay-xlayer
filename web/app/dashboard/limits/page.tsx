            ...
            <Card className="rounded-none border">
              ...
              <CardContent className="space-y-4">
                <div className="flex gap-2">
                  {PRESETS.map((preset) => (
                    <button
                      key={preset.label}
                      type="button"
                      className="flex-1 border px-2 py-2 text-xs text-left hover:bg-muted transition-colors"
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="perTxLimit" className="text-xs uppercase tracking-wider">
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="dailyBudget" className="text-xs uppercase tracking-wider">
                    Daily Budget (USDC)
                  </Label>
                  <Input
                    id="dailyBudget"
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="approvalThreshold" className="text-xs uppercase tracking-wider">
                ...
                <div className="space-y-1.5">
                  <Label htmlFor="allowlist" className="text-xs uppercase tracking-wider">
                    Merchant Allowlist
                  </Label>
                  <Input
                    id="allowlist"
              ...
              <CardContent>
                {policy ? (
                  <div className="space-y-0">
                    {[
                      { label: "Per-Tx Limit", value: `$${policy.perTxLimit}` },
                      { label: "Daily Budget", value: `$${policy.dailyBudget}` },
                      {
                        label: "Approval Gate",
