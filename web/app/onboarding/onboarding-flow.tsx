	...
	if (!agentAddress) {
		return (
			<div className="border border-dashed p-8 text-center space-y-2">
				...
				<code className="text-xs font-mono">usezenithpay.xyz/onboarding?agent=0x...</code>
			</div>
		)
	}
	...
	return (
		<div className="space-y-8">
			...
			<div className="space-y-1">
				...
				<h1 className="text-2xl font-semibold tracking-tight">Activate Your Agent</h1>
				<p className="text-sm text-muted-foreground">
			...
			{step === "connect" && (
				<div className="border p-6 space-y-4">
					...
					<p className="text-sm text-muted-foreground">
						Connect your wallet to sign the spend policy and become the policy owner.
						Only you can modify the agent’s limits.
					</p>
					<Button
			...
			{step === "done" && (
				<div className="border p-10 flex flex-col items-center gap-4 text-center">
					...
					>
						<Check className="size-6" style={{ color: "var(--brand-accent)" }} />
					</div>
					<div>
						<h2 className="text-lg font-semibold">Agent Activated</h2>
						<p className="text-sm text-muted-foreground mt-1">
							Return to your agent terminal to continue. The agent will verify the
							policy on your next request.
						</p>
					</div>
